...
public class MathUtil {
	...
	/**
	 * A 2D translation matrix for the given offset vector 2D translation matrix
	 * [[1,0,0] [0,1,0] [0,0,1]]
	 * 
	 * @param pos
	 * @return
	...
	public static double[][] translationMatrix(double[] v) {
		double[][] transform_matrix = { { 1, 0, v[0] }, { 0, 1, v[1] }, { 0, 0, 1 } };
	...
	public static double[][] scaleMatrix(double scale) {
		double[][] scale_matrix = { { scale, 0, 0 }, { 0, scale, 0 }, { 0, 0, 1 } };
		return scale_matrix;
	}
}
